...
var len__4736__auto___16106 = arguments.length;
var i__4737__auto___16107 = (0);
while(true){
if((i__4737__auto___16107 < len__4736__auto___16106)){
args__4742__auto__.push((arguments[i__4737__auto___16107]));

var G__16108 = (i__4737__auto___16107 + (1));
i__4737__auto___16107 = G__16108;
continue;
} else {
}
break;
...
var reporter__6125__auto___16109 = new cljs.core.Keyword(null,"reporter","reporter",-805360621).cljs$core$IFn$_invoke$arity$1(cljs.test.empty_env.call(null));
if(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("cljs-test-display.core","default","cljs-test-display.core/default",-853427213),null,new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),null], null), null).call(null,reporter__6125__auto___16109))){
} else {
cljs.core._add_method.call(null,cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [reporter__6125__auto___16109,new cljs.core.Keyword(null,"end-run-tests","end-run-tests",267300563)], null),(function (m__6126__auto__){
return cljs.core.reset_BANG_.call(null,figwheel.main.testing.test_result_data,m__6126__auto__);
}));
}

cljs.test.run_block.call(null,(function (){var env16104 = cljs.test.empty_env.call(null);
var summary16105 = cljs.core.volatile_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"summary","summary",380847952),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"test","test",577538877),(0)], null));
...
cljs.test.set_env_BANG_.call(null,env16104);
...
return cljs.test.block.call(null,(function (){var env__10234__auto__ = cljs.test.get_current_env.call(null);
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){
if((env__10234__auto__ == null)){
...
return cljs.core._vreset_BANG_.call(null,summary16105,cljs.core.partial.call(null,cljs.core.merge_with,cljs.core._PLUS_).call(null,cljs.core._deref.call(null,summary16105),new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242).cljs$core$IFn$_invoke$arity$1(cljs.test.get_and_clear_env_BANG_.call(null))));
})], null)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){
cljs.test.set_env_BANG_.call(null,env16104);

cljs.test.do_report.call(null,cljs.core.deref.call(null,summary16105));

cljs.test.report.call(null,cljs.core.assoc.call(null,cljs.core.deref.call(null,summary16105),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-run-tests","end-run-tests",267300563)));
...
/** @this {Function} */
(walkthrough.test_runner._main.cljs$lang$applyTo = (function (seq16103){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16103));
}));
