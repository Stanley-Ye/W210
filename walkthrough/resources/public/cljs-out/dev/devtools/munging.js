...
var temp__5718__auto____$1 = (o13153["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13154 = temp__5718__auto____$1;
return (o13154["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12251__auto__ = f;
return (o__12251__auto__["toString"]).call(o__12251__auto__);
} else {
return "";
}
}catch (e13155){var _ = e13155;
return "";
}});
...
try{var o__12251__auto___13157 = t;
(o__12251__auto___13157["cljs$lang$ctorPrWriter"]).call(o__12251__auto___13157,t,writer);
}catch (e13156){var __13158 = e13156;
}
...
var char_code = (function (){var o__12251__auto__ = (new String(char$));
return (o__12251__auto__["charCodeAt"]).call(o__12251__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12251__auto__ = String;
return (o__12251__auto__["fromCharCode"]).call(o__12251__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__13159 = num_code;
switch (G__13159) {
case (1):
return (185);
...
var o__12251__auto__ = String;
return (o__12251__auto__["fromCharCode"]).call(o__12251__auto__,superscript_code);
});
/**
...
}catch (e13161){var _e__12258__auto__ = e13161;
return false;
}})())){
...
var vec__13162 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__13162,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o13165 = temp__5718__auto__;
var temp__5718__auto____$1 = (o13165["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o13166 = temp__5718__auto____$1;
return (o13166["nameToPath"]);
} else {
return null;
}
} else {
...
args__4742__auto__.push((arguments[i__4737__auto___13174]));
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__13169){
var vec__13170 = p__13169;
var ns_detector = cljs.core.nth.call(null,vec__13170,(0),null);
...
var G__13176 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__13177 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__13176;
remaining_tokens = G__13177;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq13167){
var G__13168 = cljs.core.first.call(null,seq13167);
var seq13167__$1 = cljs.core.next.call(null,seq13167);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13168,seq13167__$1);
}));
...
var vec__13181 = cljs.core.split_with.call(null,(function (p1__13180_SHARP_){
return cljs.core.not_EQ_.call(null,p1__13180_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__13181,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__13181,(1),null);
...
var vec__13187 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__13187,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__13187,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__13190 = cljs.core.rest.call(null,remaining_tokens);
var G__13191 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__13190;
name_tokens = G__13191;
continue;
} else {
...
var vec__13194 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__13194,(0),null);
var arity = cljs.core.nth.call(null,vec__13194,(1),null);
var vec__13197 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__13197,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__13197,(1),null);
var vec__13200 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__13200,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__13200,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__13200,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__13200,(3),null);
...
var vec__13206 = result;
var munged_ns = cljs.core.nth.call(null,vec__13206,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__13206,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__13206,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__13206,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__13206,(4),null);
var arity = cljs.core.nth.call(null,vec__13206,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__13210 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__13210,(0),null);
var args = cljs.core.nth.call(null,vec__13210,(1),null);
var vec__13213 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__13213,(0),null);
var name = cljs.core.nth.call(null,vec__13213,(1),null);
...
var G__13216 = (arity + (1));
var G__13217 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__13218){
var vec__13219 = p__13218;
var arity = cljs.core.nth.call(null,vec__13219,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__13219,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13222_SHARP_){
return cljs.core.get.call(null,arities,p1__13222_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__13223_SHARP_){
return cljs.core.drop.call(null,(2),p1__13223_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__13226){
var vec__13227 = p__13226;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__13227,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq13224){
...
var G__13233 = arg;
var G__13233__$1 = (((G__13233 instanceof cljs.core.Keyword))?G__13233.fqn:null);
switch (G__13233__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__13235__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__13235__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__13235__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__13235__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__13236 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__13236,(0),null);
var fn_name = cljs.core.nth.call(null,vec__13236,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__13236,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__13236,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__13236,(4),null);
var arity = cljs.core.nth.call(null,vec__13236,(5),null);
...
var o__12251__auto__ = f;
return (o__12251__auto__["getBasis"]).call(o__12251__auto__);
});
/**
...
}catch (e13240){var _e__12258__auto__ = e13240;
...
var G__13241 = (obj[cljs.core.first.call(null,path)]);
var G__13242 = cljs.core.rest.call(null,path);
obj = G__13241;
path = G__13242;
continue;
} else {
...
var bit = cljs.core.nth.call(null,vec__13244,(0),null);
var protocol = cljs.core.nth.call(null,vec__13244,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__13247){
var vec__13248 = p__13247;
var ns = cljs.core.nth.call(null,vec__13248,(0),null);
var name = cljs.core.nth.call(null,vec__13248,(1),null);
var selector = cljs.core.nth.call(null,vec__13248,(2),null);
...
var post_process = (function (p__13252){
var vec__13253 = p__13252;
var munged_name = cljs.core.nth.call(null,vec__13253,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__13253,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__13251_SHARP_){
return (obj[cljs.core.first.call(null,p1__13251_SHARP_)]);
}),sorted_matches);
