...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13284){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13290_SHARP_){
return (!((cljs.core.meta.call(null,p1__13290_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__13291__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13295){var _e__12258__auto__ = e13295;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e13297){var _e__12258__auto__ = e13297;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13299 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13300 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13300);

try{var map__13301 = opts;
var map__13301__$1 = (((((!((map__13301 == null))))?(((((map__13301.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13301.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13301):map__13301);
var markup_db = cljs.core.get.call(null,map__13301__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13299);
}});
...
var temp__5718__auto___13306 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___13306)){
var managed_print_level_13307 = temp__5718__auto___13306;
var _STAR_print_level_STAR__orig_val__13304_13308 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13305_13309 = managed_print_level_13307;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13305_13309);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__13303_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__13303_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13304_13308);
}} else {
job_fn.call(null);
}
