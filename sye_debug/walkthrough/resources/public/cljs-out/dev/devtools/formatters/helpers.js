...
var G__13258 = devtools.prefs.pref.call(null,v);
v = G__13258;
continue;
} else {
return v;
...
}catch (e13261){var _e__12258__auto__ = e13261;
return false;
}})();
...
}catch (e13265){var _e__12258__auto__ = e13265;
return false;
}})();
...
}catch (e13267){var _e__12258__auto__ = e13267;
return false;
}}
}
});
...
var vec__13269 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__13269,(0),null);
var name = cljs.core.nth.call(null,vec__13269,(1),null);
...
return cljs.core.some.call(null,(function (p1__13272_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13272_SHARP_);
}),template);
});
