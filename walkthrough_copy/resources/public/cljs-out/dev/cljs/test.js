...
var G__11421 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__11421,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__11421;
}
}));
...
args__4742__auto__.push((arguments[i__4737__auto___11427]));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq11423){
var G__11424 = cljs.core.first.call(null,seq11423);
var seq11423__$1 = cljs.core.next.call(null,seq11423);
var G__11425 = cljs.core.first.call(null,seq11423__$1);
var seq11423__$2 = cljs.core.next.call(null,seq11423__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11424,G__11425,seq11423__$2);
}));
...
var file = cljs.core.get.call(null,map__11430__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__11430__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__11430__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__11429_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__11429_SHARP_));
...
var temp__5720__auto___11432 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11432)){
var message_11433 = temp__5720__auto___11432;
cljs.core.println.call(null,message_11433);
} else {
}
...
var temp__5720__auto___11434 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___11434)){
var message_11435 = temp__5720__auto___11434;
cljs.core.println.call(null,message_11435);
} else {
}
...
var output_dir__$1 = (function (){var G__11436 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__11436,"/"].join('');
} else {
return G__11436;
}
})();
...
var temp__5718__auto__ = ((typeof exception.stack === 'string')?(function (){var G__11438 = exception.stack;
var G__11438__$1 = (((G__11438 == null))?null:clojure.string.split_lines.call(null,G__11438));
var G__11438__$2 = (((G__11438__$1 == null))?null:cljs.core.get.call(null,G__11438__$1,depth));
if((G__11438__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11438__$2);
}
})():false);
if(cljs.core.truth_(temp__5718__auto__)){
var stack_element = temp__5718__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__11439 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11439,(0),null);
var column = cljs.core.nth.call(null,vec__11439,(1),null);
var vec__11442 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11442,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11442,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11442,(2),null);
...
var m__$1 = (function (){var G__11445 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__11449 = (function (){var G__11448 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11448);
} else {
return G__11448;
}
})();
...
return cljs.core.vary_meta.call(null,G__11450,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__11452 = e;
var G__11452__$1 = (((G__11452 instanceof cljs.core.Keyword))?G__11452.fqn:null);
switch (G__11452__$1) {
...
var vec__11454 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11454,(0),null);
var types = vec__11454;
...
return cljs.core.map.call(null,(function (p__11457){
var vec__11458 = p__11457;
var ns = cljs.core.nth.call(null,vec__11458,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11458,(1),null);
return (function (){
...
var G__11461 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__11462 = cljs.core.seq.call(null,vars__$1);
var chunk__11463 = null;
var count__11464 = (0);
var i__11465 = (0);
while(true){
if((i__11465 < count__11464)){
var v = cljs.core._nth.call(null,chunk__11463,i__11465);
var temp__5720__auto___11467 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11467)){
var t_11468 = temp__5720__auto___11467;
each_fixture_fn.call(null,((function (seq__11462,chunk__11463,count__11464,i__11465,t_11468,temp__5720__auto___11467,v,each_fixture_fn,G__11461,G__11461__$1,env,once_fixtures,each_fixtures,vec__11458,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11468)));
});})(seq__11462,chunk__11463,count__11464,i__11465,t_11468,temp__5720__auto___11467,v,each_fixture_fn,G__11461,G__11461__$1,env,once_fixtures,each_fixtures,vec__11458,ns,vars__$1))
);
} else {
}


var G__11469 = seq__11462;
var G__11470 = chunk__11463;
var G__11471 = count__11464;
var G__11472 = (i__11465 + (1));
seq__11462 = G__11469;
chunk__11463 = G__11470;
count__11464 = G__11471;
i__11465 = G__11472;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__11462);
if(temp__5720__auto__){
var seq__11462__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11462__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__11462__$1);
var G__11473 = cljs.core.chunk_rest.call(null,seq__11462__$1);
var G__11474 = c__4556__auto__;
var G__11475 = cljs.core.count.call(null,c__4556__auto__);
var G__11476 = (0);
seq__11462 = G__11473;
chunk__11463 = G__11474;
count__11464 = G__11475;
i__11465 = G__11476;
continue;
} else {
var v = cljs.core.first.call(null,seq__11462__$1);
var temp__5720__auto___11477__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___11477__$1)){
var t_11478 = temp__5720__auto___11477__$1;
each_fixture_fn.call(null,((function (seq__11462,chunk__11463,count__11464,i__11465,t_11478,temp__5720__auto___11477__$1,v,seq__11462__$1,temp__5720__auto__,each_fixture_fn,G__11461,G__11461__$1,env,once_fixtures,each_fixtures,vec__11458,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11478)));
});})(seq__11462,chunk__11463,count__11464,i__11465,t_11478,temp__5720__auto___11477__$1,v,seq__11462__$1,temp__5720__auto__,each_fixture_fn,G__11461,G__11461__$1,env,once_fixtures,each_fixtures,vec__11458,ns,vars__$1))
);
} else {
}


var G__11479 = cljs.core.next.call(null,seq__11462__$1);
var G__11480 = null;
var G__11481 = (0);
var G__11482 = (0);
seq__11462 = G__11479;
chunk__11463 = G__11480;
count__11464 = G__11481;
i__11465 = G__11482;
continue;
}
} else {
