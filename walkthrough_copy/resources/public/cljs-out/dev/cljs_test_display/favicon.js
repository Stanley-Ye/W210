...
return cljs.core.map.call(null,(function (p1__11485_SHARP_){
return html_coll.item(p1__11485_SHARP_);
...
return cljs.core.some.call(null,(function (p1__11486_SHARP_){
return cljs.core._EQ_.call(null,"icon",p1__11486_SHARP_);
...
var ctx_11487 = cvs.getContext("2d");
(ctx_11487.fillStyle = color);

ctx_11487.fillRect((0),(0),size,size);
